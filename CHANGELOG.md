...
> **发布说明：** `0.49.4` 是未公开 `0.49.3` 的替代补丁版本，包含其全部安全强化、问题修复、发布流程与文档变更；完整清单见 [0.49.3 变更记录](https://github.com/isarmg/dufs-ram/blob/v0.49.4/CHANGELOG.md#0493---2026-08-24)。
...
- `v0.49.3` 的远端门禁在公开 Release 前发现非 root 权限自测缺陷并失败关闭，没有构建或上传公开资产；标签保持不可变，修复随 `v0.49.4` 发布。
...
> **发布状态：** 附注标签 `v0.49.3` 精确指向提交 `c0123c412c8c165c37540dc510df695c150da4e6`，但正式签名包门禁发现非 root 归档权限自测缺陷后失败关闭；没有公开 GitHub Release 或便捷二进制，其变更与修复一并包含在 `0.49.4` 中。
...
[未发布]: https://github.com/isarmg/dufs-ram/compare/v0.49.4...main
